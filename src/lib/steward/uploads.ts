// File storage for Document Ops (Steward) chat attachments. Metadata lives
// on the owning ChatMessage (see ChatMessage.attachment in ../types); the
// actual bytes live on disk under data/steward-uploads/, gitignored the
// same as data/assets/ and data/branding/. Buffer-based like
...
const UPLOADS_DIR = path.join(process.cwd(), "data", "steward-uploads");
