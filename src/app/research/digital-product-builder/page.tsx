  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mt-1 text-sm text-paper-dim">
        A conversation with CRILOS that turns your content guide into a
        ...
        file. It&apos;s reviewed before you get a branded Word or PDF file.
      </p>
      ...
      {!started ? (
        <div className="hud-panel hud-panel-magenta stack mt-6 flex h-[520px] flex-col items-center justify-center p-8 text-center">
          ...
          <p className="mt-2 max-w-sm text-sm text-paper-dim">
            CRILOS will pitch four ideas grounded in your content guide, then
            walk through a brief, an outline you can revise, and a full
            draft — reviewed before it&apos;s finished.
          </p>
